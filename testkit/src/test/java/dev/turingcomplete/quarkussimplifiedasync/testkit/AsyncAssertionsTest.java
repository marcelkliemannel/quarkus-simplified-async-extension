...
import static dev.turingcomplete.quarkussimplifiedasync.testkit.AsyncAssertions.assertMethodExecutedInParallel;
...
class AsyncAssertionsTest {
  ...
  /**
   * Tests that {@link AsyncAssertions#assertMethodExecutedInParallel(Consumer)}
  ...
  void testAssertMethodExecutedInParallel_failsWithNonAsyncMethod() {
    Assertions.assertThatThrownBy(() -> assertMethodExecutedInParallel(this::nonAsyncMethod))
